...
void kernel_3D_hw(WD_t* powerIn, WD_t* tempIn, WD_t* tempOut, float Cap, float Rx, float Ry, float Rz, float dt, float amb_temp)
{
  ...
  WD_t local_tin_0 [ITY][TX];
  WD_t local_pin_0 [ITY][TX];
  WD_t local_tout_0 [TY][TX];
  WD_t local_tin_1 [ITY][TX];
  WD_t local_pin_1 [ITY][TX];
  WD_t local_tout_1 [TY][TX];

  #pragma HLS bind_storage variable = local_tin_0 type = RAM_1P impl = uram
  #pragma HLS bind_storage variable = local_pin_0 type = RAM_1P impl = uram
  #pragma HLS bind_storage variable = local_tout_0 type = RAM_1P impl = bram

   #pragma HLS bind_storage variable = local_tin_1 type = RAM_1P impl = uram
  #pragma HLS bind_storage variable = local_pin_1 type = RAM_1P impl = uram
  #pragma HLS bind_storage variable = local_tout_1 type = RAM_1P impl = bram
